...
# cara buat component project ini
ng g c views/dashboard/footer
ng g c views/dashboard/hightlight
ng g c views/dashboard/next-step
ng g c views/dashboard/resource
ng g c views/dashboard/toolbar
